...
function setupScene(doUseRaycaster){
    ...
    camera.lookAt(new THREE.Vector3(60,60,20));
    camera.up.set( 0, 0, 1 );
    ...
    var lights = [];
    lights[0] = new THREE.SpotLight( 0xececec, 0.37, 0 );
    lights[1] = new THREE.PointLight( 0xececec, 0.37, 0 );
    lights[2] = new THREE.PointLight( 0xececec, 0.37, 0 );
